...
public class StemmerWithStopWordRemoverTest {
    ...
    public void testAnalyze() throws Exception {
        ...
        expResult.add("first");expResult.add("we");expResult.add("studi");expResult.add("plagiar");
        expResult.add("pattern");expResult.add("techniqu");expResult.add("can");
        expResult.add("found");expResult.add("context");expResult.add("our");expResult.add("scope");
